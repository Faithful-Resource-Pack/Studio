export default {
 ...
 missing_page: {
  ...
  main_page: 'Tente verificar a ortografia ou ir para a página %main % para encontrar o que estava procurando.',
 },
 dashboard: {
 ...
 profile: {
  ...
  general: {
   ...
   anonymous: {
    label: 'Anônimo',
    hint:
     'Desativar página de perfil e ocultar nome de usuário e skin do Minecraft na galeria de texturas. Nomes de usuário ainda estarão acessíveis em envios de texturas para propósitos de crédito, mas não aparecerão em nenhum outro lugar.',
   },
  },
  social: {
   title: 'Links sociais',
 ...
 gallery: {
  ...
  authors_copied_to_clipboard: 'Autores do envio de textura copiados para a área de transferência',
 ...
 addons: {
  ...
  general: {
   ...
   authors: {
    ...
    hint:
     'Qualquer autor pode modificar o addon após seu envio! | Se você não encontrar ninguém na lista que deveria estar nela, contate um administrador ou desenvolvedor',
   },
  },
  info: {
   title: 'Informação',
 ...
 posts: {
  ...
  changelog_generator: {
   ...
   categorize_warning: 'Categorização por tipo pode ser imprecisa devido a como as contribuições são monitoradas!',
 ...
 database: {
  ...
  packs: {
   ...
   modal: {
    ...
    id: 'ID do pacote',
    id_creation_hint: 'Um ID de Pacote pode ser especificado manualmente ou ser gerado automaticamente.',
   ...
   submissions: {
    ...
    channels: {
     ...
     title_hint: 'Ative o Modo de Desenvolvedor e clique com o botão direito em um canal para obter IDs de canal.',
